...
def main():
    ...
    gauges_gdf = gpd.GeoDataFrame(gauges_df, geometry=gpd.points_from_xy(gauges_df.lng, gauges_df.lat), crs="EPSG:4326")
    ...
    if needed_basins:
        ...
        print("   Download data for these basins before running delineator.py")
        return False
    else:
